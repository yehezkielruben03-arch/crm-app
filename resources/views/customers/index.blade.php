            ...
            <div class="overflow-x-auto">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: var(--text-secondary);">
                                @if($customer->company_scale)
                                    <span class="px-2 py-0.5 rounded text-xs" style="background: var(--bg-secondary); border: 1px solid var(--border-color);">{{ $customer->company_scale }}</span>
                                @else
                                    -
                                @endif
                            </td>
                        ...
                        @empty
                        <tr>
                            <td colspan="{{ auth()->user()->isAdminOrAbove() ? 9 : 8 }}" class="px-6 py-16 text-center">
