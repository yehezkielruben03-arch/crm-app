                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2 grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <select name="customer_contact_id" id="contact-select" required data-selected="{{ old('customer_contact_id', $rfq->customer_contact_id) }}"
            ...
            if (initialType === 'Projek') {
                OLD_ITEMS.forEach(item => {
                    ...
                    catItems[cat].push({
                        ...
                        ceiling: String(item.ceiling || '10000'),
                        ...
                        .then(data => {
                            ...
                            if(data.contacts && data.contacts.length > 0) {
                                data.contacts.forEach(contact => {
                                    ...
                                    if(contact.id == selectedContactId || contact.is_primary) option.selected = true;
